...
Window_ChoiceList.prototype.updatePlacement = function() {
		...
		if (messagePosType === 0) {
			this.y = this._messageWindow.height + 50;
		} else if (messagePosType === 2) {
			this.y = Graphics.boxHeight - this._messageWindow.height - this.height - 50;
		}
};
...
Window_Message.prototype.adjustWindowSettings = function() {
		...
		this.height = Math.min(this.windowHeight(), Graphics.boxHeight)+24;
